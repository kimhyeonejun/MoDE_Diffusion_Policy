...
# Usage:
#   ./train_all_msillm_qualities.sh <entrypoint> <description> <index> <total>
...
TRAIN_SCRIPT="/home/khj20343/MoDE_Diffusion_Policy/mode/training_libero_msillm.py"
